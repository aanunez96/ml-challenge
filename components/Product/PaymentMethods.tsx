...
export default function PaymentMethods({ methods }: PaymentMethodsProps) {
  ...
  const getPaymentLogos = (category: string, methods: PaymentMethod[]) => {
    const logoSets = {
      credit: [
        { logo: "https://http2.mlstatic.com/storage/logos-api-admin/a5f047d0-9be0-11ec-aad4-c3381f368aaf-m.svg", name: "Visa" },
        { logo: "https://http2.mlstatic.com/storage/logos-api-admin/9cf818e0-723a-11f0-a459-cf21d0937aeb-m.svg", name: "Mastercard" },
        { logo: "https://http2.mlstatic.com/storage/logos-api-admin/b2c93a40-f3be-11eb-9984-b7076edb0bb7-m.svg", name: "American Express" },
      ],
      digital: [
        { logo: "https://http2.mlstatic.com/storage/logos-api-admin/23a95840-6817-11ec-a13d-73e40a9e9500-m.svg", name: "PayPal" },
        { logo: "https://http2.mlstatic.com/storage/logos-api-admin/f3e8e940-f549-11ef-bad6-e9962bcd76e5-m.svg", name: "Mercado Pago" },
      ],
      debit: [
        { logo: "https://http2.mlstatic.com/storage/logos-api-admin/312238e0-571b-11e8-823a-758d95db88db-m.svg", name: "Visa Débito" },
        { logo: "https://http2.mlstatic.com/storage/logos-api-admin/87075440-571e-11e8-823a-758d95db88db-m.svg", name: "Naranja" },
      ],
      cash: [
        { logo: "https://http2.mlstatic.com/storage/logos-api-admin/fec5f230-06ee-11ea-8e1e-273b5a374550-m.svg", name: "PagoFácil" },
        { logo: "https://http2.mlstatic.com/storage/logos-api-admin/443c34d0-571b-11ea-9d0f-c135b61316ba-m.svg", name: "Rapipago" },
      ]
    }
  ...
  return (
    <div className="bg-ml-bg p-4 mb-6 border border-ml-border rounded-md" data-testid="payment-methods-list">
      <h3 className="text-lg font-medium mb-4 text-ml-text">
        Medios de pago
      </h3>

      {/* Green banner - show if installments are available */}
      {methods.some(method => method.note && (method.note.includes('cuotas') || method.note.includes('meses'))) && (
        <div className="bg-ml-success text-white p-4 rounded mb-4 flex items-center gap-3">
          <svg className="w-5 h-5 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
            <path d="M2 6h20l-2 12H4L2 6zm4 0V4a2 2 0 012-2h8a2 2 0 012 2v2M9 10v2m6-2v2" stroke="currentColor" strokeWidth={1.5} fill="none" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
          <span className="text-sm font-medium">
            {methods.find(method => method.note && (method.note.includes('cuotas') || method.note.includes('meses')))?.note || 'Pagá en hasta 18 cuotas sin interés'}
          </span>
        </div>
      )}
      ...
      {groupedMethods.digital && (
        <div className="mb-4">
          <h4 className="text-sm font-medium mb-2 text-ml-text">
            Meses sin Tarjeta
          </h4>
            ...
            <div className="ml-2">
              {groupedMethods.digital.map((method, index) => (
                <div key={index}>
                  ...
                  {method.note && (
                    <p className="text-xs text-ml-muted">{method.note}</p>
                  )}
                </div>
              ))}
            </div>
